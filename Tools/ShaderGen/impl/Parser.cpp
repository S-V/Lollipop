...
void Parser::declaration() {
		...
		case 1: case 2: case 3: case 4: case 5: case 6: case 7: case 8: case 9: case 10: case 11: case 12: case 13: case 14: case 15: case 16: case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: case 32: case 33: case 34: case 35: case 36: case 37: case 38: case 39: case 40: case 41: case 43: case 44: case 45: case 46: case 47: case 48: case 50: case 53: case 54: case 55: case 56: case 57: case 58: case 59: case 60: case 61: case 62: case 64: case 65: case 66: case 67: case 68: case 69: case 71: case 72: case 73: case 74: case 75: case 76: case 77: case 78: case 79: case 80: case 82: case 83: case 84: case 85: case 86: case 87: case 88: case 89: case 90: case 92: case 93: case 94: case 95: case 97: case 98: case 99: case 100: case 101: case 102: case 103: case 104: case 106: case 107: case 108: case 110: case 111: {
			Get();
			break;
		}
...
void Parser::depth_stencil_state_declaration() {
		...
		if (la->kind == 68) {
			Get();
			Expect(1);
			newDS.FrontFaceStencilFunc = TokenBuf(); 
		}
		if (la->kind == 69) {
			Get();
			Expect(1);
			newDS.FrontFaceStencilPass = TokenBuf(); 
		}
		Expect(34);
}
...
bool Parser::StartOf(int s) {
	...
	static bool set[3][113] = {
		{T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, x},
		{x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x}
	};
...
void Errors::SynErr(int line, int col, int n) {
	...
	switch (n) {
			...
			case 68: s = coco_string_create(L"\"FrontFaceStencilFunc\" expected"); break;
			case 69: s = coco_string_create(L"\"FrontFaceStencilPass\" expected"); break;
			case 70: s = coco_string_create(L"\"RasterizerState\" expected"); break;
			case 71: s = coco_string_create(L"\"FillMode\" expected"); break;
			case 72: s = coco_string_create(L"\"CullMode\" expected"); break;
			case 73: s = coco_string_create(L"\"FrontCounterClockwise\" expected"); break;
			case 74: s = coco_string_create(L"\"DepthBias\" expected"); break;
			case 75: s = coco_string_create(L"\"DepthBiasClamp\" expected"); break;
			case 76: s = coco_string_create(L"\"SlopeScaledDepthBias\" expected"); break;
			case 77: s = coco_string_create(L"\"DepthClipEnable\" expected"); break;
			case 78: s = coco_string_create(L"\"ScissorEnable\" expected"); break;
			case 79: s = coco_string_create(L"\"MultisampleEnable\" expected"); break;
			case 80: s = coco_string_create(L"\"AntialiasedLineEnable\" expected"); break;
			case 81: s = coco_string_create(L"\"BlendState\" expected"); break;
			case 82: s = coco_string_create(L"\"BlendEnable\" expected"); break;
			case 83: s = coco_string_create(L"\"AlphaToCoverageEnable\" expected"); break;
			case 84: s = coco_string_create(L"\"SrcBlend\" expected"); break;
			case 85: s = coco_string_create(L"\"DestBlend\" expected"); break;
			case 86: s = coco_string_create(L"\"BlendOp\" expected"); break;
			case 87: s = coco_string_create(L"\"SrcBlendAlpha\" expected"); break;
			case 88: s = coco_string_create(L"\"DestBlendAlpha\" expected"); break;
			case 89: s = coco_string_create(L"\"BlendOpAlpha\" expected"); break;
			case 90: s = coco_string_create(L"\"RenderTargetWriteMask\" expected"); break;
			case 91: s = coco_string_create(L"\"StateBlock\" expected"); break;
			case 92: s = coco_string_create(L"\"StencilRef\" expected"); break;
			case 93: s = coco_string_create(L"\"BlendFactor\" expected"); break;
			case 94: s = coco_string_create(L"\"SampleMask\" expected"); break;
			case 95: s = coco_string_create(L"\"RGBA(\" expected"); break;
			case 96: s = coco_string_create(L"\"Shader\" expected"); break;
			case 97: s = coco_string_create(L"\"Code\" expected"); break;
			case 98: s = coco_string_create(L"\"=\" expected"); break;
			case 99: s = coco_string_create(L"\"VertexShader\" expected"); break;
			case 100: s = coco_string_create(L"\"PixelShader\" expected"); break;
			case 101: s = coco_string_create(L"\"<\" expected"); break;
			case 102: s = coco_string_create(L"\">\" expected"); break;
			case 103: s = coco_string_create(L"\"Inputs\" expected"); break;
			case 104: s = coco_string_create(L"\"Texture2D\" expected"); break;
			case 105: s = coco_string_create(L"\"Vertex\" expected"); break;
			case 106: s = coco_string_create(L"\"SemanticName\" expected"); break;
			case 107: s = coco_string_create(L"\"SemanticIndex\" expected"); break;
			case 108: s = coco_string_create(L"\"InputSlot\" expected"); break;
			case 109: s = coco_string_create(L"\"Shared\" expected"); break;
			case 110: s = coco_string_create(L"\"Variables\" expected"); break;
			case 111: s = coco_string_create(L"??? expected"); break;
			case 112: s = coco_string_create(L"invalid declaration"); break;
			case 113: s = coco_string_create(L"invalid render_target_declaration"); break;
			case 114: s = coco_string_create(L"invalid render_target_declaration"); break;
			case 115: s = coco_string_create(L"invalid sampler_state_declaration"); break;
			case 116: s = coco_string_create(L"invalid boolean_constant"); break;
			case 117: s = coco_string_create(L"invalid bit_mask"); break;
			case 118: s = coco_string_create(L"invalid shader_variable_decl"); break;
			case 119: s = coco_string_create(L"invalid sampler_state_decl"); break;
...
//BEGIN
	parser->SyntaxError(line,col,mxTO_ANSI(s));
//END
...
void Errors::Error(int line, int col, const wchar_t *s) {
	wprintf(L"-- line %d col %d: %ls\n", line, col, mxTO_ANSI(s));
	
//BEGIN
	parser->Error(line,col,mxTO_ANSI(s));
//END
...
//BEGIN
	parser->Warning(line,col,mxTO_ANSI(s));
//END
}
