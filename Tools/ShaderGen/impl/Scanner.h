...
public:
	...
	Scanner(const char* fileName, const unsigned char* buf, int len);
...
//BEGIN
	OSPathName	mFileName;
	
	wrLocation CurrLocation() const
	{ return wrLocation(mFileName.ToChars(),line,col); }
