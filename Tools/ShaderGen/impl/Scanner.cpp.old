...
//BEGIN
	mFileName.SetString(mxTO_ANSI(fileName));
//END
}
...
void Scanner::Init() {
	...
	keywords.set(L"FrontFaceStencilFunc", 68);
	keywords.set(L"FrontFaceStencilPass", 69);
	keywords.set(L"RasterizerState", 70);
	keywords.set(L"FillMode", 71);
	keywords.set(L"CullMode", 72);
	keywords.set(L"FrontCounterClockwise", 73);
	keywords.set(L"DepthBias", 74);
	keywords.set(L"DepthBiasClamp", 75);
	keywords.set(L"SlopeScaledDepthBias", 76);
	keywords.set(L"DepthClipEnable", 77);
	keywords.set(L"ScissorEnable", 78);
	keywords.set(L"MultisampleEnable", 79);
	keywords.set(L"AntialiasedLineEnable", 80);
	keywords.set(L"BlendState", 81);
	keywords.set(L"BlendEnable", 82);
	keywords.set(L"AlphaToCoverageEnable", 83);
	keywords.set(L"SrcBlend", 84);
	keywords.set(L"DestBlend", 85);
	keywords.set(L"BlendOp", 86);
	keywords.set(L"SrcBlendAlpha", 87);
	keywords.set(L"DestBlendAlpha", 88);
	keywords.set(L"BlendOpAlpha", 89);
	keywords.set(L"RenderTargetWriteMask", 90);
	keywords.set(L"StateBlock", 91);
	keywords.set(L"StencilRef", 92);
	keywords.set(L"BlendFactor", 93);
	keywords.set(L"SampleMask", 94);
	keywords.set(L"Shader", 96);
	keywords.set(L"Code", 97);
	keywords.set(L"VertexShader", 99);
	keywords.set(L"PixelShader", 100);
	keywords.set(L"Inputs", 103);
	keywords.set(L"Texture2D", 104);
	keywords.set(L"Vertex", 105);
	keywords.set(L"SemanticName", 106);
	keywords.set(L"SemanticIndex", 107);
	keywords.set(L"InputSlot", 108);
	keywords.set(L"Shared", 109);
	keywords.set(L"Variables", 110);
...
void Scanner::CreateHeapBlock() {
	...
	// HEAP_BLOCK_SIZE byte heap + pointer to next heap block
	newHeap = mxAlloc(HEAP_BLOCK_SIZE + sizeof(void*));
	*heapEnd = newHeap;
...
void Scanner::AppendVal(Token *t) {
	...
	t->text.SetString( mxTO_ANSI(t->val) );
}
