// p_deferred_fullscreen_spot_light_AUTO.hxx
// derived from 'D:/_/Development/SourceCode/Renderer/GPU/source/p_deferred_lighting.fx' (325)
// Defines:
...
Texture2D projector : register(t3);
