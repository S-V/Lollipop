#ifndef __NORMALS_PACKING_HLSL__
#define __NORMALS_PACKING_HLSL__
...
// [-1..1] -> [0..1]
float3 CompressNormal( in float3 N )
{
	return N * 0.5f + 0.5f;
}
...
// [0..1] -> [-1..1]
float3 ExpandNormal( in float3 v )
{
	return v * 2.0f - 1.0f;
}
...
*/
#endif //__NORMALS_PACKING_HLSL__
