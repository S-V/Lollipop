...
struct rfl_string : public TStackString<64>
{
	...
	FORCEINLINE friend mxStreamReader& operator >> ( mxStreamReader& inStream, rfl_string &o )
	{
...
FORCEINLINE void Skip_rfl_string( mxStreamReader& stream )
{
	rfl_string dummy;
	stream >> dummy;
}
...
MX_DECLARE_POD_TYPE(rfl_header);
...
MX_DECLARE_POD_TYPE(rfl_section_header);


//MX_READ_SINGLE( rfl_string, Read_rfl_string );
