...
#define APP_TITLE	"TestApp"

ConstCharPtr PATH_TO_PROJECT(
							 "Untitled/"
							 //"Untitled_simple/"
							 //"Untitled_cubes"
							 //"Untitled_concave"
							 );
ConstCharPtr PROJECT_FILE("Untitled");


class MyApp : public DemoGame
{
public:
	MyApp()
		: DemoGame()
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_SCENEVIEWER);
