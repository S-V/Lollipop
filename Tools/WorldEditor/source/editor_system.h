...
{
public:
	mxDECLARE_CLASS_ALLOCATOR(HeapGeneric,EdModule);
	...
	// if the file with editor_app settings couldn't be loaded.
	//
...
public:	// Global variables
	...
	EdGlobalSettings	settings;	// managed externally, by the editor_app
...
public:	// Serialization
	...
	// called when loading/saving editor_app settings
...
public:	// Object editing
	...
	// for notifying the manipulator ('gizmo tool') that the object is being deleted
	TEvent1< APlaceable* >	Event_PlaceableBeingDestroyed;
...
public:	// Viewports and rendering
	...
	//TEvent2< const rxSceneContext&, const AClientViewport& >	OnViewportRender;
 

	// called by the main editor_app to render all viewports
