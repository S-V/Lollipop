...
void EdViewport_TextureView::InitViewport( EdViewportWidget* widget )
{
	...
	mxCONNECT_THIS( EdSystem::Get().Event_RenderViewports, EdViewport_TextureView, Draw );
}
...
//{
//	ATexturePreview* pTexture = gRenderer.editor->GetTextureInspector()->GetTextureByName(m_currentTexture.ToChars());
	...
	: Super( parent )
{
	...
	mxCONNECT_THIS( gRenderer.BeforeMainViewportResized, EdWidget_TextureInspector, OnBeforeMainViewportResized );
	mxCONNECT_THIS( gRenderer.AfterMainViewportResized, EdWidget_TextureInspector, OnAfterMainViewportResized );
}
...
{
	m_model.SetRootObject( gRenderer.editor->GetTextureInspector() );
...
void EdDebugger::ConnectSigSlots()
{
	...
	mxCONNECT_THIS( EdSystem::Get().Event_ProjectUnloaded, EdDebugger, OnProjectUnloaded );
}
