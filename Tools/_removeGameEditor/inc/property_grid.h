...
-----------------------------------------------------------------------------
*/
class ResourceRefPropertyEditor : public QLineEdit, public APropertyEditor
{
...
public:
	...
	ResourceRefPropertyEditor( EdProperty_AssetReference* theProperty, QWidget* parent = nil );
	// reads data from the model and writes it to the editor widget.
	virtual void SetEditorData();
	// reads the contents of the editor, and writes it to the model.
	virtual void SetModelData();
...
private:
	...
	EdPropertyCollector		m_properties;
