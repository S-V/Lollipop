...
#ifndef MX_FASTDELEGATE_H
#define MX_FASTDELEGATE_H
#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
...
#undef FASTDELEGATE_USESTATICFUNCTIONHACK
	...
	public:
		FORCEINLINE detail::GenericClass* GetThisPointer()
		{
			return m_pthis;
		}
...
{
public:
	typedef fastdelegate::FastDelegate0< void > _Delegate;
...
public:
	...
	{
		m_delegates.AddUnique( delegate );
	}

	template< class X, class Y >
	void Connect( Y * obj, void (X::*func)() )
	{
		m_delegates.AddUnique( fastdelegate::MakeDelegate( obj, func ) );
	}
	...
	{
		m_delegates.Remove( fastdelegate::MakeDelegate( obj, func ) );
	}
	...
	void Emit() const
	{
		for (DelegateIterator i = m_delegates.GetStart(); i != m_delegates.GetEnd(); ++i)
		{
			(*i)();
		}
	}
...
{
public:
	typedef fastdelegate::FastDelegate1< Param1 > _Delegate;
...
{
public:
	typedef fastdelegate::FastDelegate2< Param1, Param2 > _Delegate;
...
{
public:
	typedef fastdelegate::FastDelegate3< Param1, Param2, Param3 > _Delegate;
...
{
public:
	typedef fastdelegate::FastDelegate4< Param1, Param2, Param3, Param4 > _Delegate;
...
#endif // !defined(MX_FASTDELEGATE_H)
